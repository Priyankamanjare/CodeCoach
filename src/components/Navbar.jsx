        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md border-b border-white/10 transition-all duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    {/* Logo */}
                    <div className="shrink-0 flex items-center gap-2 cursor-pointer" onClick={() => navigate(currentUser ? '/dashboard' : '/')}>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {currentUser ? (
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link to="/register" className="px-4 py-2 rounded-lg bg-white text-black font-bold text-sm hover:bg-gray-200 transition-all">
                                    Sign Up
                                </Link>
                            </div>
                        )}
